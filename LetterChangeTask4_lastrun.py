...
expName = 'LetterChangeTask4'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/maxkaplan/Documents/LetterChangeTask4/LetterChangeTask4_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    mem1 = visual.TextStim(win=win, name='mem1',
        text='',
        font='Arial',
        pos=(0.25,0.25), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    ...
    probe1 = visual.TextStim(win=win, name='probe1',
        text='',
        font='Arial',
        pos=(0.25,.25), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-3.0);
    ...
    mem5 = visual.TextStim(win=win, name='mem5',
        text=None,
        font='Arial',
        pos=None, draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-10.0);
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fix, mem1, blank, probe1, response, mem2, mem3, mem4, mem5, mem6, probe2, probe3, probe4, probe5],
        )
